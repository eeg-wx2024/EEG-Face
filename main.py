...
def main():
    ...
    file_prefix = ''
    base_path = '/data1/wuxia/dataset/FaceEEG2025/FaceEEG2025_export/same10'
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                ...
                if len(recent_acc) > 4:
                    ...
                    recent_mean = 0
                print(
                    f"fold {fold}, epoch {epoch}, train_loss {train_loss:.4f}, val_loss {val_loss:.4f}, train_acc {train_acc:.2f}, val_acc_top1 {val_acc_top1:.2f}, val_acc_top5 {val_acc_top5:.2f}, best_val_acc {best_val_acc:.2f}, recent_mean {recent_mean:.2f} (epoch {best_epoch}/{epoch})"
                )
